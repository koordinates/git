...
[,console]
----
echo FILTER_EXTENSIONS=contrib/filter-extensions/rand_cpp/rand_cpp.a >> config.mak
echo LDFLAGS=-lstdc++ >> config.mak
make
----
...
[,console]
----
echo FILTER_EXTENSIONS=contrib/filter-extensions/rand/rand.a contrib/filter-extensions/rand_cpp/rand_cpp.a >> config.mak
echo LDFLAGS=-lstdc++ >> config.mak
make
----
